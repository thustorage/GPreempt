...
# Run the following command under model/<name> directory for ROCm target
# sudo -HE env PYTHONPATH=/home/rtx/preempt/exp/tvm/python bash -c '/home/rtx/miniconda3/envs/foo/bin/python3.10 ../../script/compile.py'
